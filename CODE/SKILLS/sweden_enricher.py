...
"""Sweden Enricher - Scrape emails from Swedish company websites"""
import sys
...
SOURCE = Path("/mnt/hdd/SCRAPER_DATA/csv/EURES/Sweden/Sweden_contacts_50.csv")
OUTPUT_DIR = Path("/opt/ACTIVE/OPENDATA/DATA/ENRICHED")
OUTPUT = OUTPUT_DIR / "SE_ENRICHED.csv"
CACHE = OUTPUT_DIR / "se_domain_cache.json"
...
logging.basicConfig(level=logging.INFO, format="%(asctime)s - %(message)s",
    handlers=[logging.StreamHandler(), logging.FileHandler(LOG_DIR / f"se_{datetime.now():%Y%m%d}.log")])
