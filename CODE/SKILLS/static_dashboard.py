...
<p style="margin-top:12px;color:#444;font-size:0.65em;text-align:center">
    ...
    # Also copy to served location
    served_path = Path('/var/www/html/index.html')
    try:
        served_path.write_text(html)
    except PermissionError:
        import subprocess
        subprocess.run(['sudo', 'cp', '/tmp/dashboard.html', '/var/www/html/index.html'], check=False)
