...
CSV_FILE      = BASE / "primarii_campanie_enriched.csv"
CSV_PRIMAR    = BASE / "primarii_campanie_cu_primar.csv"
SENT_FILE     = BASE / "campaign_sent.json"
CATALOG_PDF   = BASE / "catalog_parcuri.pdf"
LOG_FILE      = BASE / "campaign_primarii.log"
...
Vă stam la dispoziție pentru detalii sau o ofertă personalizată:

  Bogdan Gavra
  Tel./WhatsApp: +40 722 380 349
  Sau răspundeți direct la acest email pentru catalogul PDF.

Cu stimă,
Bogdan Gavra
Distribuitor AVP Park România
