...
CPANEL_TOKEN = os.environ.get("A2_CPANEL_TOKEN", "CPANEL_TOKEN_REDACTED")
...
"""
    ...
    print(f'  plink -batch -pw "RASPI_PW_REDACTED" tudor@{RASPIBIG} "sudo tee -a /etc/caddy/Caddyfile" < caddy_config.txt')
    print(f'  plink -batch -pw "RASPI_PW_REDACTED" tudor@{RASPIBIG} "sudo systemctl reload caddy"')
    return True
