...
if __name__ == "__main__":
    ...
    # construieste si salveaza MEREU book-ul complet (persistenta = book intreg)
    book = build_price_book(load_offers(), include_trend=True)
    save_price_book(book)

    # --product filtreaza DOAR afisarea, nu salvarea
    view = book
    if args.product:
    ...
    if args.trends:
        ...
        print(json.dumps({"product_count": len(book), "status": "rebuild_ok"}, indent=2))
