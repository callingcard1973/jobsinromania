...
description: Publish HTML content (articles, OG tags, cross-links) to static A2 Hosting sites via cPanel API. Use whenever publishing articles/landing/SEO pages, injecting OG meta, or adding cross-links across the InterJob A2 domains.
model: opus
---
