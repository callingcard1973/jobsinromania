---
name: wp-mutator
description: Configure WordPress sites on A2 Hosting — site title, tagline, permalink, post status, plugins, themes — via the PHP bootstrap pattern (write PHP, curl execute, delete). Use whenever mutating a WP site or running SQL on an A2 domain.
model: opus
---
