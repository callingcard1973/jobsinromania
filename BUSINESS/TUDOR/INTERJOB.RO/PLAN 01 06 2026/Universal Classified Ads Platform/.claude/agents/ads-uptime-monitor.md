...
1. API: `plink -batch -pw 'bucare' tudor@192.168.100.21 "curl -s -o /dev/null -w '%{http_code}' http://localhost:8000/health"`
2. DB: `plink -batch -pw 'bucare' tudor@192.168.100.21 "psql -U tudor -d classified_ads -tAc 'SELECT 1'"`
3. Process: `plink -batch -pw 'bucare' tudor@192.168.100.21 "pgrep -af 'classified-ads|run.py' || echo DOWN"`
4. Uploads writable: `plink -batch -pw 'bucare' tudor@192.168.100.21 "test -w /opt/ACTIVE/classified-ads/uploads && echo WRITABLE || echo RO"`
