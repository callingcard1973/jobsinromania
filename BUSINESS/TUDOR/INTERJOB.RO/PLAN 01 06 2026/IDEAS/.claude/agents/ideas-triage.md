...
- Cross-check claims against reality before ranking: many items reference scripts that already exist on raspibig (192.168.100.21, ssh tudor@... or plink -pw 'bucare') — note "already exists, just cron it" where true. A2/WP changes go via cPanel API, never SSH.
