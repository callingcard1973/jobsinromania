...
def build_ro_article(data):
    ...
    html.append('<p style="text-align:center"><a href="https://interjob.ro/apply.html" style="background:#e65c00;color:white;padding:14px 28px;text-decoration:none;border-radius:5px;font-size:1.1em;display:inline-block">Aplică acum</a></p>')
...
def build_en_article(data):
    ...
    html.append('<p style="text-align:center"><a href="https://interjob.ro/apply.html" style="background:#0073aa;color:white;padding:14px 28px;text-decoration:none;border-radius:5px;font-size:1.1em;display:inline-block">Apply Now</a></p>')
